  ...
  return (
    <div className = "project">
      ...
      <div className="project-section">
        ...
        <sup className="fn-link"><a href="#footnote1">[2]</a></sup>. 
        ...
        <br></br><br></br>
        Eventually, I did get the game made. It&apos;s not perfect by any means<sup className="fn-link"><a href="#footnote1">[3]</a></sup>. 
